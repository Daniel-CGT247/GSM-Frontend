...
export default function Operation() {
    ...
    const updateOperationLists = () => {
        fetchOperations(); 
    };

    return (
        <div className="operation-container">
            <OperationLibList listId={listId} bundleId={bundleId} updateOperationLists={updateOperationLists} />
            <OperationList operations={operations} listId={listId} bundleId={bundleId} updateOperationLists={updateOperationLists} />
        </div>
    );
}
